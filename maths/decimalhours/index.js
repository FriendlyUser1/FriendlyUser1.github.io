    ...
    jQuery(document).ready(function ($) {
      ...
      $.getJSON(widget_url, function (data) {
        ...
        var css_link = $('<link>', {
          rel: 'stylesheet',
          type: 'text/css',
          href: OTCBaseUrl + '/miniApps/miniApps.css',
        })
        css_link.appendTo('head')

        switch (miniAppType) {
          case 'time-duration-calculator':
            setupTimeDurationCalculator()
          case 'convert-decimal-hours-to-minutes':
            setupConvertDecimalHoursToMinutes()
        }
